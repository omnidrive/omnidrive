...
public class GoogleDriveAccount extends BaseAccount {
    ...
    @Override
    public void deleteFolder(String fileId) throws BaseException {
        deleteFile(fileId); // In the Drive API, a folder is essentially a file [https://developers.google.com/drive/web/folder]
    }
